...
def _normalize_returns_rows(rows: list[dict[str, Any]], marketplace: str) -> list[dict[str, Any]]:
    ...
    def _number_from(value: Any) -> float | None:
        ...
        if isinstance(value, str):
            ...
            normalized = normalized.replace("?", "").replace("руб.", "").replace("руб", "")
...
HELP_DOCS_RU: dict[str, dict[str, str]] = {
    ...
    "products": {
        ...
        "content": (
            ...
            "- РњРёРЅ. С†РµРЅР°: РЅРёР¶РЅСЏСЏ РіСЂР°РЅРёС†Р° С†РµРЅС‹ РїРѕ РІР°С€РµР№ СЃС‚СЂР°С‚РµРіРёРё.\n"
    ...
    "seo_generation": {
        ...
        "content": (
            "РќР°Р·РЅР°С‡РµРЅРёРµ: РіРµРЅРµСЂР°С†РёСЏ SEO-РѕРїРёСЃР°РЅРёР№ Рё РёС‚РµСЂР°С‚РёРІРЅРѕРµ СѓР»СѓС‡С€РµРЅРёРµ.\n\n"
            ...
            "- Recheck РїСЂРѕСЃСЂРѕС‡РµРЅРЅС‹С…: РјР°СЃСЃРѕРІР°СЏ Р°РєС‚СѓР°Р»РёР·Р°С†РёСЏ Р·Р°РґР°С‡ СЃ РёСЃС‚РµРєС€РµР№ РґР°С‚РѕР№.\n"
    ...
    "wb_ads": {
        ...
        "content": (
            ...
            "  hold: С„РёРєСЃРёСЂРѕРІР°С‚СЊ С‚РµРєСѓС‰СѓСЋ Р»РѕРіРёРєСѓ Р±РµР· Р°РіСЂРµСЃСЃРёРІРЅС‹С… С€Р°РіРѕРІ.\n"
            ...
            "- РџСЂРёС‡РёРЅР° РІСЃРµРіРґР° РїРёС€РµС‚СЃСЏ РІ РєРѕР»РѕРЅРєРµ В«РџСЂРёС‡РёРЅР°В» Рё РІ СЃС‚Р°С‚СѓСЃРµ РїСЂР°РІРёР»Р°.\n\n"
            ...
            "- Р”Р»СЏ normquery РїСЂРѕРІРµСЂСЊС‚Рµ С‚РѕС‡РЅРѕРµ СЃРѕРІРїР°РґРµРЅРёРµ С„СЂР°Р·С‹ (Р±РµР· Р»РёС€РЅРёС… РїСЂРѕР±РµР»РѕРІ).\n"
            ...
            "- РќР°С‡РёРЅР°Р№С‚Рµ СЃ РєРѕРЅСЃРµСЂРІР°С‚РёРІРЅРѕРіРѕ С€Р°РіР° (50-100), С‡С‚РѕР±С‹ РЅРµ СЂР°СЃРєР°С‡Р°С‚СЊ СЂР°СЃС…РѕРґ.\n"
    ...
    "ads_bidder": {
        ...
        "content": (
            ...
            "- Р•СЃР»Рё РјРЅРѕРіРѕ skipped(cooldown), СѓРІРµР»РёС‡СЊС‚Рµ cooldown Рё СѓРјРµРЅСЊС€РёС‚Рµ С‡Р°СЃС‚РѕС‚Сѓ СЂСѓС‡РЅС‹С… Р·Р°РїСѓСЃРєРѕРІ.\n"
    ...
    "accounting": {
        ...
        "content": (
            ...
            "- РЎРєР°С‡Р°Р№С‚Рµ С€Р°Р±Р»РѕРЅ РІ В«РќР°СЃС‚СЂРѕР№РєР°С… СЂР°СЃС‡РµС‚Р°В».\n"
            ...
            "- Р’С‹С‡РёС‚Р°РµРј СЃРµР±РµСЃС‚РѕРёРјРѕСЃС‚СЊ (Р·Р°РєСѓРїРѕС‡РЅР°СЏ С†РµРЅР° * РІС‹РєСѓРїР»РµРЅРЅС‹Рµ С€С‚СѓРєРё).\n"
    ...
    "sales_stats": {
        ...
        "content": (
            ...
            "- РџРµСЂРµРєР»СЋС‡Р°С‚РµР»СЊ РјРµС‚СЂРёРєРё РіСЂР°С„РёРєР°: С€С‚СѓРєРё / РІС‹СЂСѓС‡РєР° / Р·Р°РєР°Р·С‹ / РѕС‚РєР°Р·С‹ / СЂРµРєР»Р°РјР° / С€С‚СЂР°С„С‹.\n"
            ...
            "- Р—Р°РіСЂСѓР·РёС‚СЊ СЃС‚Р°С‚РёСЃС‚РёРєСѓ: СЂСѓС‡РЅРѕР№ РїСЂРёРЅСѓРґРёС‚РµР»СЊРЅС‹Р№ СЂРµС„СЂРµС€.\n\n"
            "Р’Р°Р¶РЅРѕ:\n"
    ...
    "user_profile": {
        ...
        "content": (
            ...
            "3) РџРѕСЃР»Рµ СѓСЃРїРµС€РЅРѕР№ РїСЂРѕРІРµСЂРєРё РѕР±РЅРѕРІРёС‚Рµ РјРѕРґСѓР»СЊ В«РўРѕРІР°СЂС‹В» Рё Р·Р°РїСѓСЃС‚РёС‚Рµ РёРјРїРѕСЂС‚.\n"
    ...
    "help_center": {
        ...
        "content": (
            ...
            "- Р Р°СЃС€РёС„СЂРѕРІРєР° РєРЅРѕРїРѕРє, РїРѕР»РµР№ Рё РїРµСЂРµРєР»СЋС‡Р°С‚РµР»РµР№.\n"
            "- РўРёРїРѕРІРѕР№ СЂР°Р±РѕС‡РёР№ СЃС†РµРЅР°СЂРёР№ РїРѕ С€Р°РіР°Рј.\n"
            ...
            "- Р§РµРє-Р»РёСЃС‚ РІ РєР°СЂС‚РѕС‡РєРµ РїРѕРјРѕРіР°РµС‚ Р±С‹СЃС‚СЂРѕ РїСЂРѕРІРµСЂРёС‚СЊ, С‡С‚Рѕ РІС‹ РЅРµ РїСЂРѕРїСѓСЃС‚РёР»Рё РѕР±СЏР·Р°С‚РµР»СЊРЅС‹Рµ С€Р°РіРё.\n\n"
            ...
            "3) РџСЂРё РѕС€РёР±РєРµ СЃРІРµСЂСЏР№С‚РµСЃСЊ СЃ Р±Р»РѕРєРѕРј В«Р”РёР°РіРЅРѕСЃС‚РёРєР°В» РІ СЃРѕРѕС‚РІРµС‚СЃС‚РІСѓСЋС‰РµРј СЂР°Р·РґРµР»Рµ.\n"
...
HELP_RELEASES: list[dict[str, Any]] = [
    {
        ...
        "diff_from_previous": [
            ...
            "WB Ads: snapshot sync теперь использует более широкий набор list/endpoints и повторно добирает статистику по кампаниям, если bulk fullstats вернул только пустой или partial контекст.",
            "Возвраты: карточка и таблица показывают больше понятных полей, а действия переименованы в человекочитаемые кнопки без двусмысленности.",
            "APK UI: bidder снова держится в мобильной навигации, а заголовок верхней строки отражает текущий модуль вместо дублей внутри полезной зоны.",
        ],
        "changes": [
            "Соцсеть -> Календарь: одна кнопка «Подключить Google календарь» для каждого пользователя, персональное хранение токена и сохранение account_email / last sync state.",
            "Реклама WB: улучшено добирание названий кампаний, статусов, заказов, расхода и других метрик из нескольких WB Ads API-источников.",
            "Отзывы/Вопросы -> Возвраты: таблица и модалка деталей стали понятнее для сотрудников, с явными действиями и расширенным контекстом по заявке.",
            "APK: верхняя строка продолжает работать как заголовок модуля, а чат сохраняет персональный header только внутри конкретного треда.",
        ],
    ...
    },
    {
        ...
        "released_at": "2026-03-11",
        "current": False,
        "summary": "APK 1.5.13: Google Calendar теперь подключается одной кнопкой по личному Google-аккаунту пользователя, WB Ads добирает больше реальных данных, а в APK возвращены бидер и понятные заголовки модулей.",
        "diff_from_previous": [
            "Android APK обновлен до versionCode=19 / versionName=1.5.13.",
            "Календарь: Google OAuth переведен на персональное хранение по actor_key, поэтому каждый сотрудник подключает свой Google-календарь по своей почте, а не общий токен владельца кабинета.",
            "Календарь: для APK добавлен deep link seowibe://open и callback-трамплин, поэтому после входа в Google пользователь возвращается прямо в приложение на экран календаря.",
            "Возвраты: backend теперь вытаскивает строки не только из payload.rows, но и из claims/returns/items/data/result, а карточка получает статус, комментарии, количество, сумму, vendor code и nm_id.",
            "WB Ads: fullstats больше не суммирует одновременно верхние итоги и вложенные дневные ряды; нулевые реальные метрики считаются валидным контекстом, а пустые placeholder-ответы больше не маскируют недогрузку.",
            "APK UI: в шапке отображается название активного модуля, bidder снова доступен в мобильной навигации и сабтабах рекламы, а нижнее полезное пространство стало чище.",
        ],
        "changes": [
            "Соцсеть -> Календарь: одна кнопка «Подключить Google календарь» для каждого пользователя, плюс сохранение account_email и статуса последней синхронизации.",
            "Реклама WB: улучшено добирание названий кампаний, показов, кликов, заказов и расхода из нескольких WB Ads API-источников с более корректным partial-state.",
            "Отзывы/Вопросы -> Возвраты: таблица и карточка деталей показывают больше понятных полей вместо пустых кнопок и обрывков raw-структуры.",
            "APK: верхняя строка теперь используется как заголовок текущего модуля, а чат сохраняет персональный header только внутри открытого треда.",
        ],
        "android_download_url": "/static/downloads/seo-wibe-mobile-latest.apk",
        "android_download_name": "SEO WIBE Android (.apk)",
        "app_entry_url": "/mobile",
        "notes": "Если у пользователя уже установлен APK 1.5.12 с новым release-ключом, APK 1.5.13 ставится поверх него как обычное обновление. Если на устройстве все еще старая версия до 1.5.12, сначала удалите старое приложение один раз, затем установите новый APK 1.5.13 и войдите в аккаунт заново.",
    },
    {
        "version": "0.4.7",
    ...
    },
    {
        ...
        "diff_from_previous": [
            ...
            "РљР°Р»РµРЅРґР°СЂСЊ: СЃРёРЅС…СЂРѕРЅРёР·Р°С†РёСЏ РїРѕ Google OAuth Рё ICS URL РїРѕР»СѓС‡РёР»Р° СЃРѕС…СЂР°РЅРµРЅРёРµ last-sync СЃС‚Р°С‚СѓСЃР°, РїРѕРЅСЏС‚РЅС‹Рµ РѕС€РёР±РєРё Рё Р»РѕРєР°Р»СЊРЅСѓСЋ РѕР±СЂР°Р±РѕС‚РєСѓ РіСЂР°РЅРёС† РјРµСЃСЏС†Р°/РґРЅСЏ Р±РµР· UTC-СЃРґРІРёРіРѕРІ.",
    ...
    },
    {
        ...
        "diff_from_previous": [
            ...
            "Р’РѕР·РІСЂР°С‚С‹: СѓР»СѓС‡С€РµРЅ СЂР°Р·Р±РѕСЂ ID/СЃС‚Р°С‚СѓСЃР°/С‚РѕРІР°СЂР° РёР· РІР»РѕР¶РµРЅРЅС‹С… WB/Ozon СЃС‚СЂСѓРєС‚СѓСЂ, СѓРјРµРЅСЊС€РµРЅС‹ В«РїСѓСЃС‚С‹РµВ» СЃС‚СЂРѕРєРё РІ С‚Р°Р±Р»РёС†Рµ.",
            ...
            "РџСЂРѕС„РёР»СЊ РІ С€Р°РїРєРµ: С‚РµРїРµСЂСЊ РїРѕРєР°Р·С‹РІР°РµС‚СЃСЏ email С‚РµРєСѓС‰РµРіРѕ СЃРѕС‚СЂСѓРґРЅРёРєР° (actor_email), Р° РЅРµ email РІР»Р°РґРµР»СЊС†Р°.",
        ...
        "changes": [
            ...
            "РџСЂРѕС„РёР»СЊ РІ APK: РІ С€Р°РїРєРµ Рё РїСЂРѕС„РёР»Рµ С‚РµРїРµСЂСЊ РїРѕРєР°Р·С‹РІР°РµС‚СЃСЏ email Р°РєС‚РёРІРЅРѕРіРѕ СЃРѕС‚СЂСѓРґРЅРёРєР°, Р° РЅРµ РІР»Р°РґРµР»СЊС†Р° РєРѕРјРїР°РЅРёРё.",
            "РћР±РЅРѕРІР»РµРЅС‹ РІРµСЂСЃРёРё СЃС‚Р°С‚РёС‡РµСЃРєРёС… СЂРµСЃСѓСЂСЃРѕРІ (styles/app/social) РґР»СЏ РїСЂРёРЅСѓРґРёС‚РµР»СЊРЅРѕРіРѕ РѕР±РЅРѕРІР»РµРЅРёСЏ РєСЌС€Р° Сѓ РєР»РёРµРЅС‚РѕРІ.",
    ...
    },
    {
        ...
        "released_at": "2026-03-09",
        "current": False,
        "summary": "APK 1.5.9: РґРѕР±Р°РІР»РµРЅС‹ Р±С‹СЃС‚СЂС‹Рµ РїРµСЂРµС…РѕРґС‹ Рє Р‘РёРґРµСЂСѓ/РЎРїСЂР°РІРєРµ, СѓР»СѓС‡С€РµРЅ СЂРµРґР°РєС‚РѕСЂ С„РѕС‚Рѕ С‚РѕРІР°СЂРѕРІ Рё СѓСЃРёР»РµРЅС‹ СѓРІРµРґРѕРјР»РµРЅРёСЏ РїРѕ Р·Р°РґР°С‡Р°Рј.",
        "diff_from_previous": [
            ...
            "Р—Р°РґР°С‡Рё: СѓР»СѓС‡С€РµРЅР° РґРѕСЃС‚Р°РІРєР° СѓРІРµРґРѕРјР»РµРЅРёР№ РїСЂРё alias actor_key (u:/m:), РґРѕР±Р°РІР»РµРЅР° РІРёР·СѓР°Р»СЊРЅР°СЏ РїРѕРґСЃРІРµС‚РєР° done/overdue.",
        ...
        "changes": [
            ...
            "Р‘СѓС…РіР°Р»С‚РµСЂРёСЏ: РЅРѕСЂРјР°Р»РёР·РѕРІР°РЅС‹ С€СѓРјРЅС‹Рµ СЃРѕРѕР±С‰РµРЅРёСЏ WB finance/sales API РІ Р±РѕР»РµРµ РїРѕРЅСЏС‚РЅС‹Рµ РїСЂРµРґСѓРїСЂРµР¶РґРµРЅРёСЏ.",
            ...
            "РЎРїСЂР°РІРєР°: СЂР°СЃС€РёСЂРµРЅРѕ РѕРїРёСЃР°РЅРёРµ РјРѕРґСѓР»СЏ Р‘РёРґРµСЂ Рё РєР°СЂС‚РѕС‡РєРё С‚РѕРІР°СЂРѕРІ (РїРѕР»СЏ С†РµРЅ, СЂР°Р±РѕС‚Р° СЃ С„РѕС‚Рѕ).",
        ],
        "android_download_url": "/static/downloads/seo-wibe-mobile-latest.apk",
        "android_download_name": "SEO WIBE Android (.apk)",
        "app_entry_url": "/mobile",
    ...
    },
    {
        ...
        "released_at": "2026-03-09",
        "current": False,
        "summary": "APK 1.5.8: СѓСЃРєРѕСЂРµРЅР° СЃС‚Р°С‚РёСЃС‚РёРєР° (С„РѕСЂСЃ-СЂРµС„СЂРµС€), СѓСЃРёР»РµРЅР° РґРѕРіСЂСѓР·РєР° WB Ads РєР°РјРїР°РЅРёР№ Рё РёСЃРїСЂР°РІР»РµРЅ back РёР· С‡Р°С‚Р° РІ Android.",
        "diff_from_previous": [
            ...
            "РЎС‚Р°С‚РёСЃС‚РёРєР°: РґР»СЏ РґР»РёРЅРЅС‹С… РїРµСЂРёРѕРґРѕРІ СѓСЃРєРѕСЂРµРЅ СЂРµР¶РёРј СЃСЂР°РІРЅРµРЅРёСЏ (РїСЂРµРґС‹РґСѓС‰РёР№ РїРµСЂРёРѕРґ РѕРіСЂР°РЅРёС‡РµРЅ РјРµРЅСЊС€РёРј РґРёР°РїР°Р·РѕРЅРѕРј).",
        ...
        "changes": [
            "WB campaigns enrich СѓСЃРєРѕСЂРµРЅ РЅР° Р±РѕР»СЊС€РёС… РєР°Р±РёРЅРµС‚Р°С… Р·Р° СЃС‡РµС‚ Р±РѕР»РµРµ РєСЂСѓРїРЅРѕРіРѕ batching РЅР° РєР»РёРµРЅС‚Рµ.",
    ...
    },
    {
        ...
        "diff_from_previous": [
            ...
            "РЎРЅРёР¶РµРЅР° РЅР°РіСЂСѓР·РєР° РїСЂРё РѕС‡РµСЂРµРґРё: worker Р°РіСЂРµСЃСЃРёРІРЅРµРµ РѕС‚Р±СЂР°СЃС‹РІР°РµС‚ СѓСЃС‚Р°СЂРµРІС€РёРµ warmup/snapshot/bidder Р·Р°РґР°С‡Рё.",
        ],
        "changes": [
            ...
            "РЎРµСЂРІРµСЂРЅР°СЏ СЃС‚Р°С‚РёСЃС‚РёРєР° cache-СЃР»РѕСЏ РєСЌС€РёСЂСѓРµС‚СЃСЏ РєСЂР°С‚РєРѕ РІ РїР°РјСЏС‚Рё, С‡С‚РѕР±С‹ СЃРѕРєСЂР°С‚РёС‚СЊ РїРѕРІС‚РѕСЂРЅС‹Рµ С‚СЏР¶РµР»С‹Рµ Р°РіСЂРµРіР°С‚С‹.",
    ...
    },
    {
        ...
        "released_at": "2026-03-09",
        "current": False,
        "summary": "РСЃРїСЂР°РІР»РµРЅР° СѓСЃС‚Р°РЅРѕРІРєР° Android-РѕР±РЅРѕРІР»РµРЅРёСЏ, СѓСЃРєРѕСЂРµРЅС‹ РґРµС‚Р°Р»Рё С‚РѕРІР°СЂРѕРІ Рё РєСЌС€ WB Ads enrich.",
        "diff_from_previous": [
        ...
        "changes": [
            ...
            "РЎРѕС…СЂР°РЅРµРЅС‹ РїСѓС€-СѓРІРµРґРѕРјР»РµРЅРёСЏ, Р±РµР№РґР¶Рё Рё Р±С‹СЃС‚СЂС‹Р№ РѕС‚РІРµС‚ РІ Android.",
        ],
        "android_download_url": "/static/downloads/seo-wibe-mobile-latest.apk",
        "android_download_name": "SEO WIBE Android (.apk)",
        "app_entry_url": "/mobile",
    ...
    },
    {
        ...
        "current": False,
        "summary": "РЎС‚Р°Р±РёР»РёР·Р°С†РёСЏ СЃРµСЂРІРµСЂР°, СѓСЃРєРѕСЂРµРЅРёРµ СЂРµРєР»Р°РјС‹/РєСЌС€РµР№, online-СЃС‚Р°С‚СѓСЃС‹ Рё РѕР±РЅРѕРІР»РµРЅРЅС‹Р№ Android APK 1.5.3.",
        "diff_from_previous": [
            ...
            "WB Ads: РґРѕРіСЂСѓР·РєР° summary/СЃС‚Р°С‚РѕРІ СЂР°СЃС€РёСЂРµРЅР° Рё РІС‹РЅРµСЃРµРЅР° РІ РїСЂРѕРіСЂРµРІ РєСЌС€Р°/СЃРЅР°РїС€РѕС‚РѕРІ.",
        ...
        "changes": [
            ...
            "Р РµР»РёР· РІРєР»СЋС‡Р°РµС‚ С†РІРµС‚РѕРІС‹Рµ СѓР»СѓС‡С€РµРЅРёСЏ Р±СѓС…РіР°Р»С‚РµСЂРёРё/РѕС‚Р·С‹РІРѕРІ Рё РјРѕР±РёР»СЊРЅСѓСЋ РєРѕРјРїРѕРЅРѕРІРєСѓ РіСЂР°С„РёРєР° СЃС‚Р°С‚РёСЃС‚РёРєРё.",
            ...
            "РЎРѕС…СЂР°РЅРµРЅС‹ push-СѓРІРµРґРѕРјР»РµРЅРёСЏ, Р±РµР№РґР¶Рё Рё Р±С‹СЃС‚СЂС‹Р№ РѕС‚РІРµС‚ РёР· С€С‚РѕСЂРєРё Android.",
        ],
        "android_download_url": "/static/downloads/seo-wibe-mobile-latest.apk",
        "android_download_name": "SEO WIBE Android (.apk)",
        "app_entry_url": "/mobile",
    ...
    },
    {
        ...
        "diff_from_previous": [
            "РСЃРїСЂР°РІР»РµРЅР° РґРѕРіСЂСѓР·РєР° WB Ads: С‡Р°СЃС‚РёС‡РЅС‹Рµ РѕС‚РІРµС‚С‹ API Р±РѕР»СЊС€Рµ РЅРµ СЃС‡РёС‚Р°СЋС‚СЃСЏ С„Р°С‚Р°Р»СЊРЅРѕР№ РѕС€РёР±РєРѕР№.",
        ...
        "changes": [
            "WB/Ozon sales: СѓР»СѓС‡С€РµРЅР° РґРµРґСѓРїР»РёРєР°С†РёСЏ, РїРµСЂРµСЃС‡РёС‚Р°РЅС‹ РѕС‚РјРµРЅС‹/РІРѕР·РІСЂР°С‚С‹ Рё С„РёРЅРїРѕС‚РѕРєРё.",
    ...
    },
    {
        ...
        "diff_from_previous": [
            "Р”РѕР±Р°РІР»РµРЅС‹ bulk-РѕРїРµСЂР°С†РёРё РІ С‚РѕРІР°СЂР°С… Рё СѓР»СѓС‡С€РµРЅРёСЏ РІ СЂРµРєР»Р°РјРЅРѕРј enrich.",
        ...
        if isinstance(hydrated_summaries, dict) or isinstance(hydrated_stats, dict):
            ...
            for row in rows:
                ...
                if isinstance(summary, dict):
                    ...
                    if summary.get("status") and str(merged.get("status") or "").strip() in {"", "-", "—"}:
                        merged["status"] = str(summary.get("status") or "")
                    if summary.get("type") and str(merged.get("type") or "").strip() in {"", "-", "—"}:
                        merged["type"] = str(summary.get("type") or "")
                    if summary.get("budget") and str(merged.get("budget") or merged.get("dailyBudget") or "").strip() in {"", "-", "—"}:
...
def wb_ads_recommendations(
    ...
    def _fallback_recommendation(row: dict[str, Any]) -> tuple[str, str, str, str]:
        ...
        if spent_v < safe_min_spent and (views_v <= 0 and clicks_v <= 0 and orders_v <= 0):
            return ("РЎРѕР±СЂР°С‚СЊ РґР°РЅРЅС‹Рµ", "low", "monitor", "Р—Р° РїРµСЂРёРѕРґ РїРѕС‡С‚Рё РЅРµС‚ С‚СЂР°С„РёРєР°/СЂР°СЃС…РѕРґР°, СЂР°РЅРѕ РїСЂРёРЅРёРјР°С‚СЊ Р¶РµСЃС‚РєРёРµ СЂРµС€РµРЅРёСЏ.")
        ...
        if orders_v > 0 and cpo_v > 1200:
            return ("РћРїС‚РёРјРёР·РёСЂРѕРІР°С‚СЊ СЂР°СЃС…РѕРґС‹", "medium", "decrease_bids", "Р—Р°РєР°Р·С‹ РµСЃС‚СЊ, РЅРѕ CPO РІС‹С€Рµ С†РµР»РµРІРѕРіРѕ.")
    ...
    for cid in ids:
        ...
        if spent >= safe_min_spent and orders <= 0:
            ...
            recommendation = "РњР°СЃС€С‚Р°Р±РёСЂРѕРІР°С‚СЊ"
            priority = "medium"
            action = "scale"
...
async def upload_ai_doc(
    ...
    if len(text) < 30:
        raise HTTPException(status_code=400, detail="Р”РѕРєСѓРјРµРЅС‚ СЃР»РёС€РєРѕРј РєРѕСЂРѕС‚РєРёР№ РёР»Рё РЅРµ СѓРґР°Р»РѕСЃСЊ РёР·РІР»РµС‡СЊ С‚РµРєСЃС‚")
...
def product_details(
    ...
    if credential:
        ...
        if details_cache_meta.get("stale"):
            warnings.append("РџРѕРєР°Р·Р°РЅС‹ РєСЌС€РёСЂРѕРІР°РЅРЅС‹Рµ РґРµС‚Р°Р»Рё РєР°СЂС‚РѕС‡РєРё, API РѕР±РЅРѕРІР»СЏРµС‚СЃСЏ РІ С„РѕРЅРµ.")
    else:
...
def product_photo_upload(
    ...
    if len(raw) > 8 * 1024 * 1024:
        raise HTTPException(status_code=400, detail="Р¤Р°Р№Р» СЃР»РёС€РєРѕРј Р±РѕР»СЊС€РѕР№ (РґРѕ 8 РњР‘)")
    ...
    if force_refresh:
        try:
            ...
            payload = {
                ...
                "warnings": [f"РћС€РёР±РєР° Р·Р°РіСЂСѓР·РєРё СЃС‚Р°С‚РёСЃС‚РёРєРё: {str(exc or '')[:220]}"],
                "granularity": "day",
                "timezone": tz_name,
            }
    else:
...
def accounting_data(
    ...
    if accounting_cache_meta.get("source") == "db-stale-fallback":
        data.setdefault("warnings", []).append(
            "РџРѕРєР°Р·Р°РЅС‹ РєСЌС€РёСЂРѕРІР°РЅРЅС‹Рµ РґР°РЅРЅС‹Рµ РёР·-Р·Р° РІСЂРµРјРµРЅРЅРѕР№ РЅРµРґРѕСЃС‚СѓРїРЅРѕСЃС‚Рё API РјР°СЂРєРµС‚РїР»РµР№СЃР°."
        )
...
def accounting_purchase_price_import(
    ...
    if not rows:
        raise HTTPException(status_code=400, detail="Р¤Р°Р№Р» РїСѓСЃС‚ РёР»Рё РЅРµ СЂР°СЃРїРѕР·РЅР°РЅ. РСЃРїРѕР»СЊР·СѓР№С‚Рµ С€Р°Р±Р»РѕРЅ РёР· РјРѕРґСѓР»СЏ Р‘СѓС…РіР°Р»С‚РµСЂРёСЏ.")
    updated = 0
    skipped = 0
    unmatched: list[str] = []
    errors: list[str] = []
...
def _save_avatar_upload(file: UploadFile, *, user_id: int, prefix: str) -> str:
    ...
    if len(raw) > 4 * 1024 * 1024:
        raise HTTPException(status_code=400, detail="Р¤Р°Р№Р» СЃР»РёС€РєРѕРј Р±РѕР»СЊС€РѕР№ (РґРѕ 4 РњР‘)")
    static_root = Path(__file__).resolve().parent.parent / "static"
...
def _social_emit_due_reminders(db: Session, *, user_id: int, actor_key: str, actor_nick: str) -> None:
    ...
    for row in task_rows:
        ...
        _social_push_notification(
            ...
            title="РќР°РїРѕРјРёРЅР°РЅРёРµ Рѕ Р·Р°РґР°С‡Рµ",
            body=f"{str(row.title or '')[:140]} вЂў РґРµРґР»Р°Р№РЅ {due_iso.replace('T', ' ')} UTC",
    ...
    for row in event_rows:
        ...
        _social_push_notification(
            ...
            title="РќР°РїРѕРјРёРЅР°РЅРёРµ РєР°Р»РµРЅРґР°СЂСЏ",
...
def social_chat_send_file(
    ...
    if len(raw) > max_size:
        raise HTTPException(status_code=400, detail="Р¤Р°Р№Р» СЃР»РёС€РєРѕРј Р±РѕР»СЊС€РѕР№ (РґРѕ 12 РњР‘)")
...
def social_create_project(
    ...
    if not title:
        raise HTTPException(status_code=400, detail="РЈРєР°Р¶РёС‚Рµ РЅР°Р·РІР°РЅРёРµ РїСЂРѕРµРєС‚Р°")
...
def social_create_task(
    ...
    title = str(payload.title or "").strip()
    if not title:
        raise HTTPException(status_code=400, detail="РЈРєР°Р¶РёС‚Рµ РЅР°Р·РІР°РЅРёРµ Р·Р°РґР°С‡Рё")
    ...
    if int(assignee_user_id) != int(user.id):
        raise HTTPException(status_code=400, detail="РќР°Р·РЅР°С‡Р°С‚СЊ РјРѕР¶РЅРѕ С‚РѕР»СЊРєРѕ СѓС‡Р°СЃС‚РЅРёРєРѕРІ СЃРІРѕРµР№ РєРѕРјРїР°РЅРёРё")
    ...
    if assignee_key != actor_key:
        _social_push_notification(
            ...
            title="Р’Р°Рј РЅР°Р·РЅР°С‡РµРЅР° Р·Р°РґР°С‡Р°",
...
def social_update_task(
    ...
    if payload.title is not None:
        title = str(payload.title or "").strip()
        if not title:
            raise HTTPException(status_code=400, detail="РќР°Р·РІР°РЅРёРµ Р·Р°РґР°С‡Рё РЅРµ РјРѕР¶РµС‚ Р±С‹С‚СЊ РїСѓСЃС‚С‹Рј")
    ...
    if payload.status is not None:
        ...
        if safe_status not in {"todo", "in_progress", "done"}:
            raise HTTPException(status_code=400, detail="РќРµРєРѕСЂСЂРµРєС‚РЅС‹Р№ СЃС‚Р°С‚СѓСЃ Р·Р°РґР°С‡Рё")
        if safe_status == "done" and not _actor_is_owner(user):
            ...
            if not assignee_key or assignee_key not in actor_aliases:
                raise HTTPException(status_code=403, detail="РЎРѕС‚СЂСѓРґРЅРёРє РјРѕР¶РµС‚ Р·Р°РєСЂС‹РІР°С‚СЊ С‚РѕР»СЊРєРѕ СЃРІРѕРё Р·Р°РґР°С‡Рё")
    ...
    if old_status != "done" and str(task.status or "") == "done" and str(task.creator_key or "") != actor_key:
        _social_push_notification(
            ...
            body=f"{actor_nick} Р·Р°РєСЂС‹Р»(Р°) Р·Р°РґР°С‡Сѓ В«{str(task.title or '')[:140]}В».",
            payload={"task_id": int(task.id)},
        )
    _audit(
        db,
...
def social_add_task_comment(
    ...
    if not text_comment:
        raise HTTPException(status_code=400, detail="РљРѕРјРјРµРЅС‚Р°СЂРёР№ РїСѓСЃС‚РѕР№")
    db.add(
        SocialTaskComment(
            task_id=task.id,
...
def social_calendar_google_oauth_status(
    ...
    if not client_id:
        setup_parts.append("Добавьте SEO_WIBE_GOOGLE_CLIENT_ID")
    if not client_secret:
        setup_parts.append("Добавьте SEO_WIBE_GOOGLE_CLIENT_SECRET")
    if not (client_id and client_secret):
        setup_parts.append(f"Redirect URI для Google OAuth: {redirect_uri}")
    if not str(os.getenv("SEO_WIBE_PUBLIC_BASE_URL") or "").strip():
        setup_parts.append("Рекомендуется SEO_WIBE_PUBLIC_BASE_URL=https://seowibe.ru")
    return {
        ...
        if url_raw:
            ...
            try:
                ...
                raise HTTPException(
                    status_code=400,
                    detail=(
                        f"ICS URL вернул HTTP {int(exc.code or 0)}. Проверьте, что календарь доступен по публичной или secret ICS ссылке."
                    ),
                )
...
def social_calendar_delete_event(
    ...
    db.delete(row)
    db.commit()
    return MessageOut(message="РЎРѕР±С‹С‚РёРµ СѓРґР°Р»РµРЅРѕ")
...
def social_create_note(
    ...
    row = SocialNote(
        user_id=user.id,
        actor_key=actor_key,
        title=str(payload.title or "").strip()[:255] or "РќРѕРІР°СЏ Р·Р°РјРµС‚РєР°",
...
def social_update_note(
    ...
    row.title = str(payload.title or "").strip()[:255] or "Р‘РµР· РЅР°Р·РІР°РЅРёСЏ"
...
def admin_create_announcement(
    ...
    if ends_at and ends_at < starts_at:
        raise HTTPException(status_code=400, detail="Р”Р°С‚Р° Р·Р°РІРµСЂС€РµРЅРёСЏ РјРµРЅСЊС€Рµ РґР°С‚С‹ РїСѓР±Р»РёРєР°С†РёРё")
...
def _extract_text_from_upload(filename: str, content_type: str, raw: bytes) -> str:
    ...
    if len(raw) > 7_000_000:
        raise HTTPException(status_code=400, detail="Р¤Р°Р№Р» СЃР»РёС€РєРѕРј Р±РѕР»СЊС€РѕР№ (РјР°РєСЃРёРјСѓРј 7MB)")
...
def _extract_purchase_rows_from_iter(rows_iter: Any, idx: dict[str, int]) -> list[dict[str, Any]]:
    ...
    external_idx = _first_index(idx, {"external_id", "externalid", "nm_id", "nmid", "barcode", "С€С‚СЂРёС…РєРѕРґ"})
...
def ensure_module_enabled(db: Session, user: User, module_code: str):
    ...
    if not row:
        raise HTTPException(status_code=403, detail=f"РњРѕРґСѓР»СЊ '{module_code}' РѕС‚РєР»СЋС‡РµРЅ РґР»СЏ РІР°С€РµРіРѕ С‚Р°СЂРёС„Р°")
    if not _module_enabled_for_context(db, user, code, bool(row.enabled)):
        raise HTTPException(status_code=403, detail=f"РњРѕРґСѓР»СЊ '{module_code}' РѕС‚РєР»СЋС‡РµРЅ РґР»СЏ РІР°С€РµРіРѕ С‚Р°СЂРёС„Р°")
    if not _actor_can_use_module(user, code):
        raise HTTPException(status_code=403, detail=f"Р”РѕСЃС‚СѓРї Рє РјРѕРґСѓР»СЋ '{module_code}' РѕРіСЂР°РЅРёС‡РµРЅ РґР»СЏ РІР°С€РµРіРѕ СЃРѕС‚СЂСѓРґРЅРёРєР°")
