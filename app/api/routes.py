...
HELP_DOCS_RU: dict[str, dict[str, str]] = {
    ...
    "seo_generation": {
        ...
        "content": (
            ...
            "- Р РЂР Т‘Р В°Р В»Р С‘РЎвЂљРЎРЉ Р Р†РЎвЂ№Р В±РЎР‚Р В°Р Р…Р Р…РЎвЂ№Р Вµ / Р С›РЎвЂЎР С‘РЎРѓРЎвЂљР С‘РЎвЂљРЎРЉ Р Р†РЎРѓР Вµ SEO Р В·Р В°Р Т‘Р В°РЎвЂЎР С‘: РЎС“Р Т‘Р В°Р В»Р ВµР Р…Р С‘Р Вµ Р В·Р В°Р Т‘Р В°РЎвЂЎ.\n\n"
    ...
    "wb_questions_ai": {
        ...
        "content": (
            ...
            "- Р РЂР Т‘Р В°Р В»Р С‘РЎвЂљРЎРЉ Р Р†РЎвЂ№Р В±РЎР‚Р В°Р Р…Р Р…РЎвЂ№Р в„– Р Т‘Р С•Р С”РЎС“Р СР ВµР Р…РЎвЂљ: РЎС“Р Т‘Р В°Р В»РЎРЏР ВµРЎвЂљ Р Т‘Р С•Р С”РЎС“Р СР ВµР Р…РЎвЂљ Р С‘Р В· Р В±Р В°Р В·РЎвЂ№ Р В·Р Р…Р В°Р Р…Р С‘Р в„–.\n"
    ...
    "wb_ads": {
        ...
        "content": (
            "Р СњР В°Р В·Р Р…Р В°РЎвЂЎР ВµР Р…Р С‘Р Вµ: Р СР С•Р Р…Р С‘РЎвЂљР С•РЎР‚Р С‘Р Р…Р С– Р С‘ Р С•Р С—Р ВµРЎР‚Р В°РЎвЂљР С‘Р Р†Р Р…Р С•Р Вµ РЎС“Р С—РЎР‚Р В°Р Р†Р В»Р ВµР Р…Р С‘Р Вµ РЎР‚Р ВµР С”Р В»Р В°Р СР Р…РЎвЂ№Р СР С‘ РєР°РјРїР°РЅРёСЏР СР С‘ WB.\n\n"
            ...
            "- Р РЂР С”Р В°Р В¶Р С‘РЎвЂљР Вµ min/max/step Р С‘ cooldown (РЎРѓР ВµР С”РЎС“Р Р…Р Т‘РЎвЂ№ Р СР ВµР В¶Р Т‘РЎС“ Р В·Р В°Р С—РЎС“РЎРѓР С”Р В°Р СР С‘ Р С—РЎР‚Р В°Р Р†Р С‘Р В»Р В°).\n"
            ...
            "6) Р вЂўРЎРѓР В»Р С‘ Р В»Р С•Р С– ok/skipped Р В±Р ВµР В· Р С•РЎв‚¬Р С‘Р В±Р С•Р С” вЂ” Р Р†Р С”Р В»РЎР‹РЎвЂЎР В°Р в„–РЎвЂљР Вµ РЎвЂћР С•Р Р…Р С•Р Р†РЎвЂ№Р в„– РЎР‚Р ВµР В¶Р С‘Р С.\n\n"
            ...
            "- Р РЂР В±Р ВµР Т‘Р С‘РЎвЂљР ВµРЎРѓРЎРЉ, РЎвЂЎРЎвЂљР С• campaign_id/nm_id Р С‘Р В· Р С•Р Т‘Р Р…Р С•Р в„– Р С”Р В°Р СР С—Р В°Р Р…Р С‘Р С‘, Р В° Р Р…Р Вµ Р С‘Р В· РЎР‚Р В°Р В·Р Р…РЎвЂ№РЎвЂ¦ Р С”Р В°Р В±Р С‘Р Р…Р ВµРЎвЂљР С•Р Р†.\n"
            "- Р”Р»СЏ normquery РїСЂРѕРІРµСЂСЊС‚Рµ С‚РѕС‡РЅРѕРµ СЃРѕРІРїР°РґРµРЅРёРµ С„СЂР°Р·С‹ (Р±РµР· Р»РёСЂРЅРёС… РїСЂРѕР±РµР»РѕРІ).\n"
            "- Р вЂўРЎРѓР В»Р С‘ РЎвЂЎР В°РЎРѓРЎвЂљР С• skipped(cooldown) вЂ” РЎС“Р СР ВµР Р…РЎРЉРЎв‚¬Р С‘РЎвЂљР Вµ РЎвЂЎР В°РЎРѓРЎвЂљР С•РЎвЂљРЎС“ Р В·Р В°Р С—РЎС“РЎРѓР С”Р В° Р Р†РЎР‚РЎС“РЎвЂЎР Р…РЎС“РЎР‹ Р С‘ РЎС“Р Р†Р ВµР В»Р С‘РЎвЂЎРЎРЉРЎвЂљР Вµ cooldown.\n"
            "- Р вЂўРЎРѓР В»Р С‘ error 401/403 вЂ” Р С—Р ВµРЎР‚Р ВµРЎС“РЎРѓРЎвЂљР В°Р Р…Р С•Р Р†Р С‘РЎвЂљР Вµ WB Ads Р С”Р В»РЎР‹РЎвЂЎ Р Р† Р С—РЎР‚Р С•РЎвЂћР С‘Р В»Р Вµ.\n\n"
    ...
    "wb_ads_analytics": {
        ...
        "content": (
            ...
            "Р СџРЎР‚Р С‘Р СР ВµРЎР‚: РЎС“Р С”Р В°Р В¶Р С‘РЎвЂљР Вµ Р С—Р С•РЎРѓР В»Р ВµР Т‘Р Р…Р С‘Р Вµ 7 Р Т‘Р Р…Р ВµР в„– Р С‘ РЎРѓРЎР‚Р В°Р Р†Р Р…Р С‘РЎвЂљР Вµ CPO Р СР ВµР В¶Р Т‘РЎС“ РєР°РјРїР°РЅРёСЏР СР С‘, РЎвЂЎРЎвЂљР С•Р В±РЎвЂ№ Р Р…Р В°Р в„–РЎвЂљР С‘ Р Р…Р ВµРЎРЊРЎвЂћРЎвЂћР ВµР С”РЎвЂљР С‘Р Р†Р Р…РЎвЂ№Р Вµ."
        ),
    },
    ...
    "ads_bidder": {
        ...
        "content": (
            ...
            "1) Р РЂР С”Р В°Р В¶Р С‘РЎвЂљР Вµ campaign_id Р С‘ nm_id.\n"
    ...
    "accounting": {
        ...
        "content": (
            ...
            "- Р РЂРЎвЂЎР С‘РЎвЂљРЎвЂ№Р Р†Р В°Р ВµР С Р С”Р С•Р СР С‘РЎРѓРЎРѓР С‘Р С‘, Р В»Р С•Р С–Р С‘РЎРѓРЎвЂљР С‘Р С”РЎС“, РЎвЂ¦РЎР‚Р В°Р Р…Р ВµР Р…Р С‘Р Вµ, РЎС“Р Т‘Р ВµРЎР‚Р В¶Р В°Р Р…Р С‘РЎРЏ, РЎв‚¬РЎвЂљРЎР‚Р В°РЎвЂћРЎвЂ№, РЎР‚Р ВµР С”Р В»Р В°Р СРЎС“.\n"
    ...
    "ai_assistant": {
        ...
        "content": (
            ...
            "- Р РЂРЎвЂљР С•РЎвЂЎР Р…Р С‘РЎвЂљР Вµ Р СР В°РЎР‚Р С”Р ВµРЎвЂљР С—Р В»Р ВµР в„–РЎРѓ, Р С—Р ВµРЎР‚Р С‘Р С•Р Т‘ Р С‘ Р СР С•Р Т‘РЎС“Р В»РЎРЉ, Р ВµРЎРѓР В»Р С‘ Р Р…РЎС“Р В¶Р ВµР Р… РЎвЂљР С•РЎвЂЎР Р…РЎвЂ№Р в„– Р С•РЎвЂљР Р†Р ВµРЎвЂљ.\n\n"
            "Р’Р°Р¶РЅРѕ:\n"
...
HELP_RELEASES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "diff_from_previous": [
            ...
            "Р РЂР В»РЎС“РЎвЂЎРЎв‚¬Р ВµР Р…Р В° РЎС“РЎРѓРЎвЂљР С•Р в„–РЎвЂЎР С‘Р Р†Р С•РЎРѓРЎвЂљРЎРЉ РЎРѓР ВµРЎРѓРЎРѓР С‘Р С‘: Р С—РЎР‚Р С‘ Р С”РЎР‚Р В°РЎвЂљР С”Р С•Р Р†РЎР‚Р ВµР СР ВµР Р…Р Р…РЎвЂ№РЎвЂ¦ 401/403 Р С—РЎР‚Р С‘Р В»Р С•Р В¶Р ВµР Р…Р С‘Р Вµ Р Р…Р Вµ Р Р†РЎвЂ№Р В±РЎР‚Р В°РЎРѓРЎвЂ№Р Р†Р В°Р ВµРЎвЂљ Р Р† Р В°Р Р†РЎвЂљР С•РЎР‚Р С‘Р В·Р В°РЎвЂ Р С‘РЎР‹ Р С—РЎР‚Р ВµР В¶Р Т‘Р ВµР Р†РЎР‚Р ВµР СР ВµР Р…Р Р…Р С•.",
    ...
    },
    {
        ...
        "android_download_name": "SEO WIBE Android (.apk)",
        "app_entry_url": "/mobile",
        "notes": "APK Р С—РЎР‚Р С•Р Р†Р ВµРЎР‚РЎРЏР ВµРЎвЂљ Р С•Р В±Р Р…Р С•Р Р†Р В»Р ВµР Р…Р С‘РЎРЏ Р С—РЎР‚Р С‘ Р В·Р В°Р С—РЎС“РЎРѓР С”Р Вµ Р С‘ Р С—РЎР‚Р ВµР Т‘Р В»Р В°Р С–Р В°Р ВµРЎвЂљ Р’В«Р РЂРЎРѓРЎвЂљР В°Р Р…Р С•Р Р†Р С‘РЎвЂљРЎРЉ / Р СџР С•Р В·Р В¶Р ВµР’В». Р СџР С•РЎРѓР В»Р Вµ Р В·Р В°Р С–РЎР‚РЎС“Р В·Р С”Р С‘ Р С•РЎвЂљР С”РЎР‚РЎвЂ№Р Р†Р В°Р ВµРЎвЂљРЎРѓРЎРЏ РЎРѓР С‘РЎРѓРЎвЂљР ВµР СР Р…РЎвЂ№Р в„– РЎС“РЎРѓРЎвЂљР В°Р Р…Р С•Р Р†РЎвЂ°Р С‘Р С” Android. Р РЂР Р†Р ВµР Т‘Р С•Р СР В»Р ВµР Р…Р С‘РЎРЏ Р Р† РЎв‚¬РЎвЂљР С•РЎР‚Р С”Р Вµ Р С—Р С•Р Т‘Р Т‘Р ВµРЎР‚Р В¶Р С‘Р Р†Р В°РЎР‹РЎвЂљ Р В±РЎвЂ№РЎРѓРЎвЂљРЎР‚РЎвЂ№Р в„– Р С•РЎвЂљР Р†Р ВµРЎвЂљ.",
    },
    {
        "version": "0.3.0",
    ...
    },
    {
        ...
        "diff_from_previous": [
            ...
            "Р РЂРЎРѓР С”Р С•РЎР‚Р ВµР Р…РЎвЂ№ РЎРѓРЎвЂ Р ВµР Р…Р В°РЎР‚Р С‘Р С‘ Р С–Р ВµР Р…Р ВµРЎР‚Р В°РЎвЂ Р С‘Р С‘ Р С‘ Р С•РЎвЂљР С—РЎР‚Р В°Р Р†Р С”Р С‘ Р С•РЎвЂљР Р†Р ВµРЎвЂљР С•Р Р†.",
        ],
        "changes": [
            "РСЃРїСЂР°РІР»РµРЅС‹ РјРѕР±РёР»СЊРЅС‹Рµ UI-СЂРµРіСЂРµСЃСЃРёРё Рё РѕР±СЂР°Р±РѕС‚РєР° direct-С‡Р°С‚РѕРІ.",
            "Р РЂР В»РЎС“РЎвЂЎРЎв‚¬Р ВµР Р…РЎвЂ№ РЎРѓРЎвЂљР В°РЎвЂљРЎС“РЎРѓРЎвЂ№ Р В·Р В°Р С–РЎР‚РЎС“Р В·Р С”Р С‘ РЎР‚Р ВµР С”Р В»Р В°Р СР Р…РЎвЂ№РЎвЂ¦ Р С”Р В°Р СР С—Р В°Р Р…Р С‘Р в„–.",
        ],
        "android_download_url": "/static/downloads/seo-wibe-mobile-latest.apk",
        "android_download_name": "SEO WIBE Mobile Android (.apk)",
        "app_entry_url": "/mobile",
    ...
    if (not fast) and placeholder_ids:
        ...
        if isinstance(extra_summaries, dict) and extra_summaries:
            for row in rows:
                ...
                if name and not (name.lower().startswith("РєР°РјРїР°РЅРёСЏ ") or name.lower().startswith("campaign ")):
                    row["name"] = name
...
def wb_ads_recommendations(
    ...
    def _fallback_recommendation(row: dict[str, Any]) -> tuple[str, str, str, str]:
        ...
        if orders_v > 0 and cpo_v > 0 and cpo_v <= 1200:
            return ("Р СџР С•Р Т‘Р Т‘Р ВµРЎР‚Р В¶Р С‘Р Р†Р В°РЎвЂљРЎРЉ Р С‘ Р СР В°РЎРѓРЎв‚¬РЎвЂљР В°Р В±Р С‘РЎР‚Р С•Р Р†Р В°РЎвЂљРЎРЉ", "low", "scale", "РљР°РјРїР°РЅРёСЏ Р С—РЎР‚Р С‘Р Р…Р С•РЎРѓР С‘РЎвЂљ Р В·Р В°Р С”Р В°Р В·РЎвЂ№ РЎРѓ Р С—РЎР‚Р С‘Р ВµР СР В»Р ВµР СРЎвЂ№Р С CPO.")
        ...
        if (not is_running_v) and (views_v > 0 or clicks_v > 0):
            return ("Р СџРЎР‚Р С•Р Р†Р ВµРЎР‚Р С‘РЎвЂљРЎРЉ Р С‘ Р Р†Р С•Р В·Р С•Р В±Р Р…Р С•Р Р†Р С‘РЎвЂљРЎРЉ", "low", "start", "РљР°РјРїР°РЅРёСЏ РЎРѓР ВµР в„–РЎвЂЎР В°РЎРѓ Р Р…Р Вµ Р В°Р С”РЎвЂљР С‘Р Р†Р Р…Р В°, Р Р…Р С• Р С—Р С• Р Р…Р ВµР в„– Р В±РЎвЂ№Р В»Р В° Р В°Р С”РЎвЂљР С‘Р Р†Р Р…Р С•РЎРѓРЎвЂљРЎРЉ.")
    ...
    for cid in ids:
        ...
        if spent >= safe_min_spent and orders <= 0:
            ...
            reason = "Р вЂ™РЎвЂ№РЎРѓР С•Р С”Р С‘Р в„– CPO, РєР°РјРїР°РЅРёСЏ Р Р…Р ВµРЎРЊРЎвЂћРЎвЂћР ВµР С”РЎвЂљР С‘Р Р†Р Р…Р В°."
        elif (not is_running) and orders >= 2 and cpo > 0 and cpo <= 900:
            recommendation = "Р’РѕР·РѕР±РЅРѕРІРёС‚СЊ РїРѕРєР°Р·С‹"
            priority = "low"
            action = "start"
            reason = "РљР°РјРїР°РЅРёСЏ Р Р…Р В° Р С—Р В°РЎС“Р В·Р Вµ/Р В·Р В°Р Р†Р ВµРЎР‚РЎв‚¬Р ВµР Р…Р В°, Р Р…Р С• Р СР ВµРЎвЂљРЎР‚Р С‘Р С”Р С‘ Р В±РЎвЂ№Р В»Р С‘ РЎР‚Р В°Р В±Р С•РЎвЂЎР С‘Р Вµ."
...
def list_products(
    ...
    placeholder_categories = {"", "-", "вЂ”", "n/a", "na", "none", "null", "Р Р…Р ВµРЎвЂљ", "unknown"}
...
def delete_products_local_bulk(payload: ProductBulkDeleteIn, user: User = Depends(get_current_user), db: Session = Depends(get_db)):
    ...
    return MessageOut(
        message=(
            f"Р РЂР Т‘Р В°Р В»Р ВµР Р…Р С• Р С‘Р В· Р В»Р С•Р С”Р В°Р В»РЎРЉР Р…Р С•Р в„– Р В±Р В°Р В·РЎвЂ№: {deleted_count}"
            if missing_count <= 0
            else f"Р РЂР Т‘Р В°Р В»Р ВµР Р…Р С• Р С‘Р В· Р В»Р С•Р С”Р В°Р В»РЎРЉР Р…Р С•Р в„– Р В±Р В°Р В·РЎвЂ№: {deleted_count} (Р Р…Р Вµ Р Р…Р В°Р в„–Р Т‘Р ВµР Р…Р С•: {missing_count})"
        )
    )
...
def delete_seo_jobs(payload: SeoDeleteRequest, user: User = Depends(get_current_user), db: Session = Depends(get_db)):
    if payload.delete_all:
        ...
        if not payload.job_ids:
            raise HTTPException(status_code=400, detail="Р РЂР С”Р В°Р В¶Р С‘РЎвЂљР Вµ Р В·Р В°Р Т‘Р В°РЎвЂЎР С‘ Р Т‘Р В»РЎРЏ РЎС“Р Т‘Р В°Р В»Р ВµР Р…Р С‘РЎРЏ")
        jobs = db.scalars(
            select(SeoJob).where(
                SeoJob.user_id == user.id,
    ...
    db.commit()
    return MessageOut(message=f"Р РЂР Т‘Р В°Р В»Р ВµР Р…Р С• SEO Р В·Р В°Р Т‘Р В°РЎвЂЎ: {deleted}")
...
def accounting_expense_create(payload: AccountingExpenseIn, user: User = Depends(get_current_user), db: Session = Depends(get_db)):
    ...
    if not category:
        raise HTTPException(status_code=400, detail="Р РЂР С”Р В°Р В¶Р С‘РЎвЂљР Вµ Р С”Р В°РЎвЂљР ВµР С–Р С•РЎР‚Р С‘РЎР‹ РЎР‚Р В°РЎРѓРЎвЂ¦Р С•Р Т‘Р В°")
...
def _social_identity_by_key(db: Session, actor_key: str) -> tuple[int, int | None, str]:
    ...
    if key.startswith("m:"):
        ...
        if not member or not member.is_active:
            raise HTTPException(status_code=404, detail="Р РЂРЎвЂЎР В°РЎРѓРЎвЂљР Р…Р С‘Р С” Р Р…Р Вµ Р Р…Р В°Р в„–Р Т‘Р ВµР Р…")
...
def _social_emit_due_reminders(db: Session, *, user_id: int, actor_key: str, actor_nick: str) -> None:
    ...
    for row in event_rows:
        ...
        _social_push_notification(
            ...
            body=f"{str(row.title or '')[:140]} РІР‚Сћ {start_iso.replace('T', ' ')} UTC",
...
def social_create_group_chat(
    ...
    if len(title) < 2:
        raise HTTPException(status_code=400, detail="Р РЂР С”Р В°Р В¶Р С‘РЎвЂљР Вµ Р Р…Р В°Р В·Р Р†Р В°Р Р…Р С‘Р Вµ Р С–РЎР‚РЎС“Р С—Р С—РЎвЂ№")
...
def social_create_project(
    ...
    if not title:
        raise HTTPException(status_code=400, detail="Р РЂР С”Р В°Р В¶Р С‘РЎвЂљР Вµ Р Р…Р В°Р В·Р Р†Р В°Р Р…Р С‘Р Вµ Р С—РЎР‚Р С•Р ВµР С”РЎвЂљР В°")
...
def social_tasks_list(
    ...
    for task in rows:
        ...
        _social_push_notification(
            ...
            body=f"{task.title[:120]} вЂ” Р Т‘Р ВµР Т‘Р В»Р В°Р в„–Р Р… Р С‘РЎРѓРЎвЂљР ВµР С”.",
...
def social_create_task(
    ...
    title = str(payload.title or "").strip()
    if not title:
        raise HTTPException(status_code=400, detail="Р РЂР С”Р В°Р В¶Р С‘РЎвЂљР Вµ Р Р…Р В°Р В·Р Р†Р В°Р Р…Р С‘Р Вµ Р В·Р В°Р Т‘Р В°РЎвЂЎР С‘")
...
def admin_create_announcement(
    ...
    title = str(payload.title or "").strip()
    if not title:
        raise HTTPException(status_code=400, detail="Р РЂР С”Р В°Р В¶Р С‘РЎвЂљР Вµ Р В·Р В°Р С–Р С•Р В»Р С•Р Р†Р С•Р С” Р С•Р В±РЎР‰РЎРЏР Р†Р В»Р ВµР Р…Р С‘РЎРЏ")
...
def build_seo_job_out(db: Session, job: SeoJob) -> SeoJobOut:
    ...
    name = product.name if product else "Р РЂР Т‘Р В°Р В»Р ВµР Р…Р Р…РЎвЂ№Р в„– РЎвЂљР С•Р Р†Р В°РЎР‚"
...
def _campaign_name_is_placeholder(name: str, campaign_id: int) -> bool:
    ...
    if not text:
        return True
    if re.fullmatch(r"(РєР°РјРїР°РЅРёСЏ|campaign)\s*\d+", text):
        return True
    cid = int(campaign_id or 0)
    if cid > 0 and text in {f"РєР°РјРїР°РЅРёСЏ {cid}", f"campaign {cid}"}:
        return True
    return False
...
def _ensure_team_email_is_available(
    ...
    *,
    ...
    if not candidate:
        raise HTTPException(status_code=400, detail="Р РЂР С”Р В°Р В¶Р С‘РЎвЂљР Вµ email РЎРѓР С•РЎвЂљРЎР‚РЎС“Р Т‘Р Р…Р С‘Р С”Р В°")
...
def _validate_team_member_password(raw_password: str, *, required: bool) -> str:
    ...
    if not password:
        if required:
            raise HTTPException(status_code=400, detail="Р РЂР С”Р В°Р В¶Р С‘РЎвЂљР Вµ Р С—Р В°РЎР‚Р С•Р В»РЎРЉ РЎРѓР С•РЎвЂљРЎР‚РЎС“Р Т‘Р Р…Р С‘Р С”Р В° (Р СР С‘Р Р…Р С‘Р СРЎС“Р С 8 РЎРѓР С‘Р СР Р†Р С•Р В»Р С•Р Р†)")
        return ""
    if len(password) < 8:
